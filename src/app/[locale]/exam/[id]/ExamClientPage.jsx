...
export default function ExamClientPage({ quizData, id }) {
  ...
  // Initialize client-side state from saved progress
  useEffect(() => {    
    ...
    if (savedState && savedState.started) {
      ...
      if (savedState.timeLeft !== undefined && quiz.limitTime) {
        // If there's a saved time, use it, otherwise use the full time
        setTimeLeft(savedState.timeLeft > 0 ? savedState.timeLeft : quiz.limitTime);
      }
